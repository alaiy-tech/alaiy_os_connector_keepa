...
@frappe.whitelist()
def find_products(filter_params, marketplace=None, include_insights=False):
    import json
    ...
    return _product_finder.find_products(params, marketplace=domain, include_insights=frappe.utils.cint(include_insights))

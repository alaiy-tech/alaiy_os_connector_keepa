...
def decode_offer(raw_offer, stale_after_hours=24):
    ...
    return {
        ...
        "condition_comment": raw_offer.get("conditionComment"),
        ...
        "is_preorder": bool(raw_offer.get("isPreorder")),
        "is_prime_exclusive": bool(raw_offer.get("isPrimeExcl")),
        ...
        "min_order_qty": raw_offer.get("minOrderQty") or 0,
        "coupon": raw_offer.get("coupon"),
